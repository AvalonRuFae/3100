...
\begin{itemize}
    ...
    \item \textbf{Test Types:} Functional, security, negative testing, data integrity validation, UAT
\end{itemize}
...
\paragraph{REQ-7: Kanban-like status} Display task: Available, In Progress, Review, Completed.
